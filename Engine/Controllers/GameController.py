...
class GameController:
    ...
    def _InitController(self):
        ...
        self._RestPointController=RestPointController(self._MapHolder)
    ...
    def Run(self):
        while self._CurrentPlayTime < self._TotalPlayTime:
            ...
            Player_1_MovementCommand
            Player_2_MovementCommand
            try:
    ...
    def _WasPlayerDestroyedInPreviousRound(self):
    ...
    def _FillTimeOutVictory(self):
        self._CompleteGameState.victory.winningireason = WinnigReason.TOTAL_POINTS_TIME_OUT
        if self._CompleteGameState.player_1_GameState.MyPlayer.score > self._CompleteGameState.player_2_GameState.MyPlayer.score:
            self._CompleteGameState.victory.winner = WinnigPlayer.PLAYER_1
        return
        if self._CompleteGameState.player_1_GameState.MyPlayer.score < self._CompleteGameState.player_2_GameState.MyPlayer.score:
            self._CompleteGameState.victory.winner = WinnigPlayer.PLAYER_2
